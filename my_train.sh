...
IMAGE_SHAPE="512 512"
SAVE_MODEL_DIR="/disk_code/code/lung_cancer_detection/trained_models_2022_6_25"
TRAIN_TIMES=2
...
do
  ...
  do
    for model_type in  "Unet" #"UnetPlusPlus"
    ...
    do
      ...
      for encoder_name in  "resnet34" #"densenet121"
      do
